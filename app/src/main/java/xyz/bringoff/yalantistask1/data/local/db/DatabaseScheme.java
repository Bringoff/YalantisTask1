...
public final class DatabaseScheme {
    ...
    public static class TicketTable implements BaseColumns {
        ...
        public static final String COLUMN_STATUS_ID_NAME = "status_id_name";
        ...
        public static final String CREATE_TABLE = String.format(
                "create table if not exists %s (%s primary key, %s text, %s text, %s text, %s text," +
                        " %s text, %s text, %s integer, %s integer, %s integer, %s real," +
                        " %s real, %s integer, %s text);",
                TABLE_NAME, _ID, COLUMN_STATUS_NAME, COLUMN_STATUS_ID_NAME, COLUMN_TYPE, COLUMN_DESCRIPTION, COLUMN_ADDRESS,
